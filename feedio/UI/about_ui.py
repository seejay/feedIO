...
#
# Created: Sat Jul  2 23:29:21 2011
...
class Ui_About(object):
    def setupUi(self, About):
        ...
        self.lblCopyright.setAlignment(QtCore.Qt.AlignRight|QtCore.Qt.AlignTrailing|QtCore.Qt.AlignVCenter)
        self.lblCopyright.setObjectName("lblCopyright")
        self.image = QtGui.QLabel(About)
        self.image.setGeometry(QtCore.QRect(-19, 0, 471, 171))
        self.image.setText("")
        self.image.setPixmap(QtGui.QPixmap(":/images/about.png"))
        self.image.setAlignment(QtCore.Qt.AlignCenter)
        self.image.setObjectName("image")
        self.btnClose = QtGui.QPushButton(About)
        self.btnClose.setGeometry(QtCore.QRect(344, 375, 85, 27))
        ...
        self.btnLicense.setGeometry(QtCore.QRect(111, 375, 85, 27))
        sizePolicy = QtGui.QSizePolicy(QtGui.QSizePolicy.Fixed, QtGui.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.btnCredits.setGeometry(QtCore.QRect(20, 375, 85, 27))
        sizePolicy = QtGui.QSizePolicy(QtGui.QSizePolicy.Fixed, QtGui.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
    ...
    def retranslateUi(self, About):
        ...
        self.lblAbout.setText(QtGui.QApplication.translate("About", "feedIO is a feed aggregator that tracks the user\'s reading tastes and prioritizes\n"
"the content from future feed updates according to the recorded user preferences.", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.btnCredits.setText(QtGui.QApplication.translate("About", "Credits", None, QtGui.QApplication.UnicodeUTF8))
