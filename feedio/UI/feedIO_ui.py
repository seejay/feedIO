...
#
# Created: Wed Aug 10 00:32:20 2011
...
class Ui_feedIO(object):
    def setupUi(self, feedIO):
        ...
        self.menuNotifications.addAction(self.actionTurnOffNotifications)
        self.menuNotifications.addAction(self.actionTurnOnNotifications)
        self.menu_Twitter.addAction(self.actionSignInToTwitter)
        self.menu_Twitter.addAction(self.actionSignOffFromTwitter)
        self.menu_Read_It_Later.addAction(self.actionSignInToRIL)
        self.menu_Read_It_Later.addAction(self.actionSignOffFromRIL)
        self.menuTools.addSeparator()
        self.menuTools.addAction(self.menuNotifications.menuAction())
        self.menuTools.addSeparator()
        self.menuTools.addAction(self.menu_Twitter.menuAction())
        self.menuTools.addAction(self.menu_Read_It_Later.menuAction())
        self.menuTools.addSeparator()
    ...
    def retranslateUi(self, feedIO):
        ...
        self.menuNotifications.setTitle(QtGui.QApplication.translate("feedIO", "&Notifications", None, QtGui.QApplication.UnicodeUTF8))
        self.menu_Twitter.setTitle(QtGui.QApplication.translate("feedIO", "&Twitter", None, QtGui.QApplication.UnicodeUTF8))
        self.menu_Read_It_Later.setTitle(QtGui.QApplication.translate("feedIO", "&Read It Later", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.actionRemoveFeed.setShortcut(QtGui.QApplication.translate("feedIO", "Del", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.actionUpVote.setShortcut(QtGui.QApplication.translate("feedIO", "Ctrl+U", None, QtGui.QApplication.UnicodeUTF8))
        self.actionDownVote.setText(QtGui.QApplication.translate("feedIO", "&Down Vote", None, QtGui.QApplication.UnicodeUTF8))
        self.actionDownVote.setShortcut(QtGui.QApplication.translate("feedIO", "Ctrl+D", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.actionFetchFeed.setShortcut(QtGui.QApplication.translate("feedIO", "Ctrl+F", None, QtGui.QApplication.UnicodeUTF8))
        self.actionFetchAllFeeds.setText(QtGui.QApplication.translate("feedIO", "Fetch &All Feeds", None, QtGui.QApplication.UnicodeUTF8))
        self.actionFetchAllFeeds.setShortcut(QtGui.QApplication.translate("feedIO", "Ctrl+R", None, QtGui.QApplication.UnicodeUTF8))
        self.actionVisitPage.setText(QtGui.QApplication.translate("feedIO", "&Visit Page", None, QtGui.QApplication.UnicodeUTF8))
        self.actionVisitPage.setShortcut(QtGui.QApplication.translate("feedIO", "Ctrl+V", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.actionTurnOffNotifications.setText(QtGui.QApplication.translate("feedIO", "Turn o&ff Notifications", None, QtGui.QApplication.UnicodeUTF8))
        self.actionTurnOnNotifications.setText(QtGui.QApplication.translate("feedIO", "Turn o&n Notifications", None, QtGui.QApplication.UnicodeUTF8))
        self.actionSignInToTwitter.setText(QtGui.QApplication.translate("feedIO", "Sign &into Twitter", None, QtGui.QApplication.UnicodeUTF8))
